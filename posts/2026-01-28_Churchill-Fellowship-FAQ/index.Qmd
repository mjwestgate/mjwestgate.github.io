...
date: 2026-01-27
image: stockholm_sunset_2018_square.jpeg
categories:
  - type-Synthesis
---

Hello there! Welcome. I'm Martin and this is my first post. I'll be using this blog for a few things, but at first, it'll be a place where I record information related to my Churchill Fellowship. I've structured this first post as an FAQ.
...
<figure class="figure">
  <img src="science_team_melbs_2025.jpeg" class="img-fluid figure-img img-rounded" style="width:100%">
...
In terms of what a Churchill Fellow _does_, their [website](https://www.churchilltrust.com.au/become-a-fellow/) states:
...
My project is ["To investigate global-scale solutions in biodiversity informatics"](https://www.churchilltrust.com.au/project/to-investigate-global-scale-solutions-in-biodiversity-informatics/), which basically means to find ways to flag potentially erroneous occurrence records.
...
This method also has drawbacks, however. It requires users to understand quite deeply what those checks are and how they work before making a decision. That requires a lot of documentation, which is cumbersome both for maintainers and users. The main problem, though, is that this approach is entirely binary; there is no estimate of likelihood or uncertainty.


#### Why have you chosen to explore statistical modelling?

When we talk about data 'quality', we are implicitly making a statement about how trustworthy we think a piece of data is. Such decisions are not binary, but subtle and gradated. Statistical modelling treats this as a probabalistic problem, which is a natural fit for our intuitive perception of what quality _means_.  Statistical approaches to data quality have practical benefits as well:
...
<figure class="figure">
  <img src="stockholm_sunset_2018_landscape.jpeg" class="img-fluid figure-img img-rounded" style="width:100%">
